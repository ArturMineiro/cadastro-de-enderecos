...
const Enderecos: React.FC = () => {
  ...
  const handleAtualizar = () => setAtualizarLista(!atualizarLista);

  return (
<div className="min-h-screen bg-gray-100 dark:bg-gray-900 p-4 md:p-8 flex flex-col items-center gap-10">
  {/* Formulário */}
  <Card className="w-full max-w-full md:max-w-4xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl hover:shadow-3xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
    ...
    <CardContent className="space-y-6 p-4 md:p-6">
      <FormEndereco onSaved={handleAtualizar} />
    </CardContent>
  </Card>
  ...
  <Card className="w-full max-w-full md:max-w-4xl bg-white dark:bg-gray-800 rounded-3xl shadow-2xl hover:shadow-3xl transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
    ...
    <CardContent className="overflow-x-auto p-4 md:p-6">
      <ListaEnderecos atualizar={atualizarLista} />
    </CardContent>
  </Card>
</div>
  );
